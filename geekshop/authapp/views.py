    ...
    def post(self, request, *args, **kwargs):
        ...
        if form.is_valid():
            ...
            if self.send_verify_link(user):
                ...
                messages.success(request, 'Вы успешно зарегистрировались', extra_tags='register')
                return HttpResponseRedirect(reverse('authapp:login'))
            else:
...
#         return send_mail(subject,message, settings.EMAIL_HOST_USER,[user.email],fail_salently=False)
#
#     def verify(self,email,activate_key):
#         pass
